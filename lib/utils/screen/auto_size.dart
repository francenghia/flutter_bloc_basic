...
class AutoSize {
  ...
  static double getDevicePixelRatio() {
    ...
    if (originalHeight > originalWidth) {
      // 竖屏
      _devicePixelRatio =
          window.physicalSize.width / AutoSize._screenStandard;
    } else {
      // 横屏
      _devicePixelRatio =
          window.physicalSize.height / AutoSize._screenStandard;
    }
  ...
  static Widget appBuilder(BuildContext context, Widget? widget) {
    ...
    return MediaQuery(
      ...
      data: MediaQuery.of(context).copyWith(
          size: Size(AutoSize._screenWidth, AutoSize._screenHeight),
          devicePixelRatio: AutoSize._devicePixelRatio,
          textScaleFactor:
